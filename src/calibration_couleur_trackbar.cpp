...
int main(){
 ...
 while(true){
  ...
  IplImage* imgThresh = GetThresholdedImage(imgHSV);
    cvDilate(imgThresh, imgThresh, kernel,1);
    cvErode(imgThresh, imgThresh, kernel,1);
	//cvMorphologyEx(imgThresh,imgThresh,NULL,kernel,CV_MOP_CLOSE,2); //fermeture
    	//cvMorphologyEx(imgThresh,imgThresh,NULL,kernel,CV_MOP_OPEN,2);	//ouverture
